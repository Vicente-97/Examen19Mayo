...
public class Serie {
	...
	public void addTemporada( String nombreTemporada) throws SerieException {
		if(temporadas.contains(new Temporada(nombreTemporada))) {
			throw new SerieException("Error esta temporada ya existe");
		}else {
	...
	public String listarTemporadasPorNotaMedia() {
		...
		this.temporadas.sort(new ComparatorNotaMedia());
		for(Temporada t : temporadas) {
			sb.append(t.getNombreTemporada()+", "+t.getNumeroCapitulos()+", "+t.getNotaMedia()+System.lineSeparator());
		}
	...
	public String listarTemporadasPorNumeroDeCapitulos() {
		...
		ordenarTemporadasPorNumeroDeCapitulos();
		
		StringBuilder sb = new StringBuilder();
		for(Temporada t : temporadas) {
			sb.append(t.getNombreTemporada()+", "+t.getNumeroCapitulos()+", "+t.getNotaMedia())
	...
	public void ordenarTemporadasPorNombre() {
		temporadas.sort(new Comparator<Temporada>() {

			@Override
			public int compare(Temporada o1, Temporada o2) {
				return o1.getNombreTemporada().compareTo(o1.getNombreTemporada());
			}
		});
	}
