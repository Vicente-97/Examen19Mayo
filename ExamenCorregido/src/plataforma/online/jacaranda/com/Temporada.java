...
public class Temporada {
	...
	public void anadirCapituloDespues(String nombreCapituloAnnadir, String nombreCapituloAnterior) throws SerieException{
		if(this.capitulos.contains(nombreCapituloAnterior)) {
			this.capitulos.add(this.capitulos.indexOf(nombreCapituloAnterior), nombreCapituloAnnadir);
		}else {
			throw new SerieException("Error no se ha encontrado ninguna coincidencia");
		}
	}
	...
	public String primerCapituloQueContieneEstaPalabara(String palabra) throws SerieException {
		 String primerCapitulo="";
		 
		 Iterator<String> iteradorCapitulos = this.capitulos.iterator();
		 
		 while(iteradorCapitulos.hasNext()&& primerCapitulo=="") {
			 if(iteradorCapitulos.next()==palabra) {
				 primerCapitulo+= iteradorCapitulos.next();
			 }
		 }if (primerCapitulo=="") {
			 throw new SerieException("Error no hay coincidencias");
		 }
	...
	public String toString() {
		...
		info=nombreTemporada+   " Numero de capitulos " + capitulos.size() + 
